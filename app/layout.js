...
export const metadata = {
  title: 'estheticsbynoemi - Premium Skin Care Services || Brandon, Florida',
  description:
  ...
  openGraph: {
    title: 'estheticsbynoemi - Premium Skin Care Services',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'estheticsbynoemi - Premium Skin Care Services'
      }
    ],
