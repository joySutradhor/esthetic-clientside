...
function AboutUs () {
  ...
  return (
    <section className='e__section__gap'>
      <div className='grid grid-cols-2 justify-between  gap-10  border p-10'>
        <div>
          <div>
            ...
            <p>
              ...
              Lorem Ipsum.lectronic typesetting, remaining essentially
            ...
            <div className='mt-24 '>
              ...
              <div className='grid grid-cols-2 gap-4 mt-5 '>
                {skincareWorkflow?.workflow?.map(step => (
                  <div
                    key={step.step}
                    className='p-4 e__secondary__bg rounded-md'
                  >
                    <h3>
