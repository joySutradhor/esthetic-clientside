    ...
    <section className="e__section__gap mb-24 md:mb-20">
      <div className="e__office__container e__secondary__bg ">
              ...
              <div className="e__office__bussiness__info">
                ...
                <div className="space-y-4">
                  ...
                  <p className=" flex items-center space-x-1">
                    <FaLocationDot />{" "}
                    <span>12950 US-301 S Riverview, FL 33578</span>
                  </p>
        ...
        <p className="text-center text-sm  mt-14 md:mt-14 ">
          © All rights reserved. Esthetics by Noemi |{" "}
          <span className="font-medium underline underline-offset-2 text-blue-900">
            <a href="https://www.linkedin.com/in/joy-sutradhor/">
              Developed by Joy Sutradhor
            </a>
          </span>
        </p>
      </div>
