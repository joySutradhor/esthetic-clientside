    ...
    <header className='absolute top-10 left-0 z-50 w-full'>
      <nav className='header__footer__main__gapping'>
        <div className='e__nav__wrapper'>
          <div>
            <ul className='e__nav__item__parent'>
              <button className='e__header__btn__menu'>
                <GiHamburgerMenu />
              </button>
              <NavButton
                navButtonText='Home'
          ...
          <div className='flex gap-5 items-center'>
            <div>
                <p className='flex items-center gap-1  text-white/80 font-medium'> <span className='animate-bounce'><SiWhatsapp/></span> +1 (813) 416-9628 </p> 
            </div>
