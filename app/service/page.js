...
export const metadata = {
  title: 'Services | estheticsbynoemi | Premium Skin Care in Brandon, Florida',
  description:
    'Explore the premium skin care services offered by estheticsbynoemi, including mesotherapy, Meso Botox, facials, and other rejuvenating treatments for healthier, youthful skin.',
  keywords:
    'estheticsbynoemi, skin care services, mesotherapy, Meso Botox, facial treatments, anti-aging, skin rejuvenation, beauty services, Brandon Florida, skin care, hydration, skin health',
  openGraph: {
    title:
      'Services | estheticsbynoemi | Premium Skin Care in Brandon, Florida',
    description:
      'Discover a range of advanced skin care services at estheticsbynoemi. From mesotherapy to Meso Botox, we offer non-invasive treatments for glowing, youthful skin.',
    images: [
      {
        url: 'https://i.ibb.co/cK6DX7jJ/ourmission.jpg', // Image for social sharing
        width: 1200,
        height: 630,
        alt: 'estheticsbynoemi - Skin Care Services'
      }
    ],
        ...
        <div className='e__service__container'>
          <div>
            ...
            <h2 className='mt-3 mb-8'>
              Nuestros servicios disponibles para el Paciente
            </h2>
          </div>
          <div>
            <AllService />
